...
Mode: reply | Round: {N} | Scope: X38-D-12, X38-D-21, X38-D-23, X38-D-24 (Clean OOS & Certification)
Input: /var/www/trading-bots/btc-spot-dev/research/x38/debate/010-clean-oos-certification/codex/round-{N-1}_reviewer-reply.md
Output: /var/www/trading-bots/btc-spot-dev/research/x38/debate/010-clean-oos-certification/claude_code/round-{N}_author-reply.md
...
HEADER (mandatory):
  # Round {N} — Author Reply: Clean OOS & Certification
  **Topic**: 010 — Clean OOS & Certification
  **Author**: claude_code
  **Date**: {DATE}
  **Responds to**: `codex/round-{N-1}_reviewer-reply.md`
