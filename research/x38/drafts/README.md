...
| `architecture_spec.md` | 001 + 002 + 004 + 007 + 008 + 009 + 010 + 011 + **013** + **016** + **017** | Campaign model, session lifecycle, directory structure, data management, immutability, Clean OOS flow. Firewall: enforcement mechanism (state machine, typed schema, filesystem). Deployment boundary. **Convergence analysis.** **Bounded recalibration path.** **Epistemic search policy (phenotype contracts, promotion ladder).** | SEEDED (§1 from Topic 001 2026-03-23; §5 from Topic 007 2026-03-23; §7 from Topic 002 2026-03-25) |
