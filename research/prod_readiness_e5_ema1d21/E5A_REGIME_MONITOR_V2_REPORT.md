# E5A-V2 — MDD-Only Regime Monitor (E5+EMA1D21 core)
...
## 5. Backtest: E5 Vanilla vs E5+Monitor-V2 (harsh, 50 bps RT)

| Metric | E5 Vanilla | E5+Monitor-V2 | Delta |
|--------|----------:|-------------:|------:|
| Sharpe | 1.1255 | 1.2826 | +0.1572 |
| CAGR % | 42.74 | 50.06 | +7.32 |
| MDD % | 49.87 | 42.51 | -7.35 |
| Trades | 202 | 184 | -18 |
| Monitor exits | -- | 0 | |
| Final NAV | 94731.38 | 159129.78 | +64398.39 |
...
**POSITIVE**: Sharpe +0.1572, CAGR +7.32%, MDD -7.35%. All metrics improve.
...
bear markets. Vanilla E5 makes 202 trades; monitored makes 184
(-18). These avoided entries were false signals during
