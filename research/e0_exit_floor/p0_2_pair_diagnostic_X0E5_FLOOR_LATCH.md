# Pair Diagnostic: X0E5_FLOOR_LATCH vs X0_E5EXIT

## Section 1: Machine Diagnostic (auto-filled)

**Classification**: near_identical
  near_equal_1bp=99.1%, corr=0.993
  subsampling_reliable=False

**Pair Profile** (n_bars=15647):
  equal_rate_tol=99.1%
  near_equal_1bp=99.1%
  near_equal_10bp=99.2%
  same_direction=99.2%
  return_correlation=0.993
  exposure_agreement=99.3%

**Bootstrap (Sharpe)**: p=0.498, CI=[-0.098, +0.097], width=0.195
**Bootstrap (geo growth)**: p=0.455, CI=[-0.000018, +0.000016]
**Subsampling**: p=0.020, CI=[-0.002, -0.002], support=0.00
**Consensus**: gap=43.5pp — FAILED

**DSR (X0E5_FLOOR_LATCH)**: {27: 0.97, 54: 0.94, 100: 0.91, 200: 0.87, 500: 0.80, 700: 0.77}  (advisory only)
**DSR (X0_E5EXIT)**: {27: 0.97, 54: 0.94, 100: 0.91, 200: 0.87, 500: 0.80, 700: 0.77}  (advisory only)

**Caveats**:
  - Subsampling unreliable: near_equal_1bp_rate=99.1% > 80% threshold
  - Subsampling support=0.00 (expected for available effect sizes)
  - Very high return correlation (0.993) — strategies may be near-equivalent

**Suggested route**: no_action_default
  Reason: near_identical pair, no anomalous signal

**Generated**: 2026-03-16T20:41:49.236651+00:00
