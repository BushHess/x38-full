...
_SPEC = importlib.util.spec_from_file_location("base_module_btcsd_20260318_c3_trade4h15m_d1_participation_permission", _BASE_PATH)
...
def run_candidate(
    ...
    return _MOD._run_candidate_internal(
        ...
        disabled_layers={"d1_participation_permission"},
    )
