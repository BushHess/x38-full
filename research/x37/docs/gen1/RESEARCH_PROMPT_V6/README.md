Sau khi dán phần prompt trong PROMPT_FOR_V6_HANDOFF.md vào vòng chat tiếp theo, ta sẽ thu được 4 deliverables: RESEARCH_PROMPT_V6.md, CONTAMINATION_LOG_V2.md, CHANGELOG_V5_TO_V6.md, và CONVERGENCE_STATUS.md. Đây là các tài liệu cần thiết để bắt đầu một phiên nghiên cứu mới.
...
/var/www/trading-bots/btc-spot-dev/research/x37/docs/gen1/RESEARCH_PROMPT_V6/SPEC_REQUEST_PROMPT.md
...
Quang trọng: Nghiên cứu PROMPT_FOR_V7_HANDOFF
