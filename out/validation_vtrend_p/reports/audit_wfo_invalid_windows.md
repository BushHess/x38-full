...
- Generated: 2026-03-05 04:06:46 UTC
...
|---:|---|---|---:|---:|---:|
| 0 | False | baseline_zero_trade_count | NaN | 4 | 0 |

| low-trade window_id | valid_window | low_trade_window | low_trade_reason | delta_harsh_score |
|---:|---|---|---|---:|
| 2 | True | True | both_below_min_trades_for_power | 157.9250 |

## Summary snapshot

- invalid_windows_count: `2`
- low_trade_windows_count: `1`
- stats_all_valid.median_delta: `8.5111`
- stats_all_valid.worst_delta: `-201.7132`
- stats_power_only.median_delta: `-4.3329`
- stats_power_only.worst_delta: `-201.7132`
