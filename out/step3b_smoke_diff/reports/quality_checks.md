...
| Invariants | on | `fail` | `results/invariant_violations.csv` |
...
| candidate | 100.00 | -0.189718 | -0.142742 |
...
- Collection note: limit reached, additional violations were truncated.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| candidate | harsh | 72 | 2.676 | 0.0278 | 12.00 | 0.00 | 0.00 | 4.708 |
